            ...
            <div className="w-full lg:w-[66.66%]">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Understanding the Basics of GST Registration
                </h1>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    GST registration is a crucial step for businesses in India. This
                    comprehensive guide will help you understand the basics of GST
                    registration, eligibility criteria, and the registration process.
                  </p>
                  ...
                  <div className="relative">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 md:gap-x-6 lg:gap-x-8">
                      <RelatedPost
                        title="GST Filing Process Explained"
                        image="/images/blog/post-01.jpg"
                        slug="#"
                        date="Jan 15, 2024"
                      />
                      <RelatedPost
                        title="Understanding GST Input Tax Credit"
